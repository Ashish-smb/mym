...
<!-- about us -->
<section class="px-6 lg:px-14 mb-4">
    <div class="grid lg:grid-cols-2 gap-12">
        <div class="mb-2 lg:mb-0">
            ...
            The education is being imparted from Nursery to Grade V. We pay attention to every student. No caste, color, Gender, or Religion is Considered While Rendering the services. It's easier to take than to give. It's better to give than to take. The thrill of taking last a day. The Thrill of giving lasts a lifetime.
            </p>
        </div>
...
<section class="px-6 lg:px-14">
    ...
    <div class="lg:py-12">
        ...
        <div class="grid grid-cols-2 gap-4 ">
            <div class="bg-orange-200 rounded py-4 group ">
                <img src="assets/imgs/fonts/manav-yog-manch-members.png" alt="" class="w-1/2 mx-auto group-hover:scale-110 duration-500">
                <h2 class="text-center text-xl font-bold">
                    Become a Volunteer
                </h2>
            </div>
            <div class="bg-orange-200 rounded py-4 group">
                <img src="assets/imgs/fonts/manav-yog-manch-donation.png" alt="" class="w-1/2 mx-auto group-hover:scale-110 duration-500">
                <h2 class="text-center text-xl font-bold">
                    Give Donation
                </h2>
            </div>
            <div class="bg-orange-200 rounded py-4 group">
                <img src="assets/imgs/fonts/manav-yog-manch-trustpng.png" alt="" class="w-1/2 mx-auto group-hover:scale-110 duration-500">
                <h2 class="text-center text-xl font-bold">
                    Help Someone
                </h2>
            </div>
            <div class="bg-orange-200 rounded py-4 group">
                <img src="assets/imgs/fonts/manav-yog-manch-education.png" alt="" class="w-1/2 mx-auto group-hover:scale-110 duration-500">
                <h2 class="text-center text-xl font-bold">
                    Help for Education
                </h2>
            </div>
