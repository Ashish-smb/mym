...
<section class="px-6 lg:px-14 mt-6 lg:mt-0 mb-5">
    <div class="grid lg:grid-cols-2 flex-wrap">
        <div class="mb-4 lg:mb-0" >
            <div class="flex relative bg-slate-200 items-center gap-2 w-36 rounded-full px-8 py-2">
                ...
                <h1 class="font-bold text-orange-600">Contact us </h1>
            </div>
        ...
        <div>
            <div class="hidden lg:block h-full">
                <img src="assets/imgs/manav-yog-manch-about-us-help-childrens.jpg" alt="" class="w-full h-full object-fill">
            </div>
 ...
 <section class="py-10 px-6 lg:px-14">
    <div class="grid lg:grid-cols-2">
        <div class="col-span-1">
            <h5 class="bg-orange-600 text-lg px-2 font-bold text-white inline-block">
                contact 
            </h5>
            <span class=" text-lg px-2 font-bold">information</span>
    ...
    <div class="grid lg:grid-cols-4 md:grid-cols-2 gap-5 my-10">
        <div class="col-span-1 ">
            <div class="bg-gray-100  justify-center text-center py-8 rounded-3xl border-dashed border-2 border-purple-300">
                ...
                <p class="text-amber-950 font-bold text-lg py-5 ">Phone Number</p>
                <a href="tel:9565162223" class="text-gray-800">(+91)9565162223</a>
            </div>
        </div>
        <div class="col-span-1">
            <div class="bg-gray-200  justify-center text-center py-8 rounded-3xl border-dashed border-2 border-purple-300">
                ...
                <a href="mailto:manavyogmanch@gmail.com" class="text-gray-800">manavyogmanch@gmail.com
                </a>
            </div>
        </div>
        <div class="col-span-1">
            <div class="bg-gray-300  justify-center text-center py-8 rounded-3xl border-dashed border-2 border-purple-300">
                ...
                <p class="text-amber-950 font-bold text-lg py-5 ">Work Hours</p>
